...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        num_per_class = []
        if dataset_name is 'Semantic3D':
            #num_per_class = np.array([18192185, 37065524, 6119417, 118766910, 1031654, 36165111],
            num_per_class = np.array([37065524, 6119417, 118766910, 1031654, 36165111],
                                     dtype=np.int32)
